...
CHANNEL_STRUCTURE = [
    ...
    {
        'type':    'text',
        'name':    '🏪│plugin-listings',
        'key':     'ch_listings',
        'topic':   'All approved plugins. Use /browse or /search to find plugins.',
        'overwrites': {
            '@everyone':     discord.PermissionOverwrite(view_channel=True, send_messages=False),
            '💧 Dropper':    discord.PermissionOverwrite(send_messages=False),
        },
    },
    {
        'type':    'text',
        'name':    '🆕│new-releases',
        'key':     'ch_new_releases',
        'topic':   'Latest plugin releases. Auto-posted when a plugin is approved.',
        'overwrites': {
            '@everyone': discord.PermissionOverwrite(view_channel=True, send_messages=False),
        },
    },
    {
        ...
        'name':    '🔍│plugin-search',
        'key':     'ch_search',
        'topic':   'Use /search <query> to find plugins.',
    },
    {
        'type':    'text',
        'name':    '⭐│reviews',
    ...
    {
        'type':    'text',
        'name':    '💧│drop-your-plugin',
        'key':     'ch_drop',
        'topic':   'Drop your Minecraft plugins here! Use /upload to submit.',
        'overwrites': {
            '@everyone':         discord.PermissionOverwrite(view_channel=False),
    ...
    },
    {
        ...
        'name':    '📥│pending-review',
        'key':     'ch_pending',
        'topic':   'Plugins awaiting admin approval.',
        'overwrites': {
            '@everyone':    discord.PermissionOverwrite(view_channel=False),
